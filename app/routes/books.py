...
@router.post("/create",response_model=schemas.BookOut,summary="Create a new book",description="Add a new book to your tracking with its Title, Author, and Total Pages.")
...
@router.get("/", response_model=list[schemas.BookOut],summary="Get all books",description="Retrieve a list of all books added by the current user.")
...
@router.get("/{book_id}",response_model=schemas.BookOut,summary="Get a book by ID",description="Retrieve the details of a specific book by its ID.")
...
@router.put("/{book_id}", response_model=schemas.BookOut,summary="Update book progress",description="Update the number of pages read for a specific book. The status will be updated automatically based on the total pages and pages read.")
